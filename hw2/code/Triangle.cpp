...
std::array<Vector4f, 3> Triangle::toVector4() const
{
    ...
    // std::transform make the 3D verctor of 3D vector v into another 3D vector of 4D vector, store it in res
    // the lambda function shows how it transforms 3D vector into 4D vector
